  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        "",
        "• The **@Giveaways** role is only for members who are currently claiming a giveaway reward.",
        "• Do **not** claim the role if you are not claiming a reward.",
        "• Keep your reward claim and ticket private.",
        "• Do not screenshot or expose the private ticket.",
        "• Do not share the ticket contents or the sender's information.",
        "• Follow the instructions provided by the staff team.",
        "• When your giveaway ticket is closed, **Tickety Bot will remove the @Giveaways role**.",
        "",
